...
<body>
    ...
    @endif
        <div class="flex flex-col items-center">
            <h1 class="mt-14 text-5xl flex items-center">
            ...
            @endif
            <div class="w-full max-w-sm p-3 pt-2 mb-32 @if(session()->has('loginError')) mt-6 @else mt-5 @endif bg-white border border-gray-200 sm:p-4 md:p-7 rounded-lg shadow mx-auto">
                <form class="space-y-6" action="{{route('authenticateUser')}}" method="POST" autocomplete="off">
                    @csrf
                    <h5 class="text-xl font-medium text-gray-900">User Login</h5>
                    <div>
                    ...
                    <div>
                        <a href="{{route('forgotPassword')}}" class="text-sm font-medium text-blue-700 hover:underline dark:text-blue-500">Lupa Password?</a>
                    </div>
                    <div>
                        ...
                        <p class="ml-1 mt-4">Belum punya akun? Silahkan <a class="text-blue-600 underline" href="{{route('register')}}"> Register</a></p>
                    </div>
                </form>
            </div>
        </div>
